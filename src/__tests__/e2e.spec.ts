...
describe('E2E Tests', () => 
{
    ...
    beforeAll(async () => 
    {
        ...
        // Configure ValidationPipe to match main.ts configuration
    ...
    describe('User Registration and Profile Management Journey', () => 
    {
        ...
        it('should prevent duplicate email registration', async () => 
        {
            ...
            await request(app.getHttpServer())
                .post('/users')
                .send(userData)
                .expect(409); // Expect 409 Conflict for duplicate resources
        });
    ...
    describe('Subscription Management Journey', () => 
    {
        it('should complete subscription lifecycle', async () => 
        {
            ...
            // Activate subscription (new subscriptions are PENDING by default)
            await request(app.getHttpServer())
            ...
            const changeTierResponse = await request(app.getHttpServer())
                .patch(`/subscriptions/${subscriptionId}/change-tier`)
                .send(changeTierData)
                .expect(200);
